  ...
  func @mm(%arg0: memref<1024x1024xf32>, %arg1: memref<1024x1024xf32>, %arg2: memref<1024x1024xf32>) {
    ...
    scf.for %arg3 = %c0 to %c1024 step %c1 {
      scf.for %arg4 = %c0 to %c1024 step %c1 {
        store %cst, %arg2[%arg3, %arg4] : memref<1024x1024xf32>
        scf.for %arg5 = %c0 to %c1024 step %c1 {
          %0 = load %arg0[%arg3, %arg5] : memref<1024x1024xf32>
          %1 = load %arg1[%arg5, %arg4] : memref<1024x1024xf32>
          %2 = load %arg2[%arg3, %arg4] : memref<1024x1024xf32>
          %3 = mulf %0, %1 : f32
          %4 = addf %2, %3 : f32
          store %4, %arg2[%arg3, %arg4] : memref<1024x1024xf32>
        }
      }
    }
    return
